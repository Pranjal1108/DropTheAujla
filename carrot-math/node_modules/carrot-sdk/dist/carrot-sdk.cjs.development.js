...
var Fraction = /*#__PURE__*/function () {
  ...
  _proto.toFixed = function toFixed(decimalPlaces) {
    ...
    return new Decimal.Decimal(this.numerator.toString()).dividedBy(this.denominator.toString()).toFixed(decimalPlaces);
  };
...
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  function CurrencyAmount(currency, amount) {
    ...
    if (amount instanceof Fraction) {
      ...
      _this = _Fraction.call(this, amount, bignumber.BigNumber.from(10).pow(currency.decimals)) || this;
    }
  ...
  _proto.plus = function plus(other) {
    !this.currency.equals(other.currency) ?  invariant(false, 'tried to sum different currencies')  : void 0;
    return new CurrencyAmount(this.currency, _Fraction.prototype.add.call(this, other));
  };

  _proto.minus = function minus(other) {
    !this.currency.equals(other.currency) ?  invariant(false, 'tried to subtract different currencies')  : void 0;
...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[exports.ChainId.MAINNET] = ZERO_ADDRESS, _FACTORY_ADDRESS[exports.ChainId.RINKEBY] = '0xa60c831dc30A6564Aa23044Ade594C2f1e3c9929', _FACTORY_ADDRESS);
var REALITY_ADDRESS = (_REALITY_ADDRESS = {}, _REALITY_ADDRESS[exports.ChainId.MAINNET] = '0x325a2e0F3CCA2ddbaeBB4DfC38Df8D19ca165b47', _REALITY_ADDRESS[exports.ChainId.RINKEBY] = '0x3D00D77ee771405628a4bA4913175EcC095538da', _REALITY_ADDRESS);
...
Currency.ETHER = /*#__PURE__*/new Currency( /*#__PURE__*/bignumber.BigNumber.from(18), 'ETH', 'Ether');
var Token = /*#__PURE__*/function (_Currency) {
  _inheritsLoose(Token, _Currency);

  function Token(chainId, address$1, decimals, symbol, name) {
    var _this;

    _this = _Currency.call(this, decimals, symbol, name) || this;
    _this.chainId = chainId;
    !address.isAddress(address$1) ?  invariant(false, address$1 + " is not a valid address")  : void 0;
    _this.address = address.getAddress(address$1);
    return _this;
  }
...
var KpiToken = /*#__PURE__*/function (_Token) {
  ...
  function KpiToken(chainId, address, symbol, name, kpiId, totalSupply, oracle, question, lowerBound, higherBound, finalProgress, expiresAt, finalized, kpiReached, creator, collateral, fee) {
    ...
    _this = _Token.call(this, chainId, address, bignumber.BigNumber.from('18'), symbol, name) || this;
    !(collateral.token.chainId === chainId) ?  invariant(false, 'inconsistent chain id in collateral')  : void 0;
    !fee.token.equals(collateral.token) ?  invariant(false, 'inconsistent collateral and fee token')  : void 0;
    !(fee.token.chainId === chainId) ?  invariant(false, 'inconsistent chain id in collateral')  : void 0;
    !lowerBound.lt(higherBound) ?  invariant(false, 'inconsistent scalar bounds')  : void 0;
    _this.kpiId = kpiId;
  ...
  _createClass(KpiToken, [{
    ...
    get: function get() {
      ...
      return new Decimal__default(this.finalProgress.toString()).dividedBy(kpiScalarRange.toString()).times(100);
    }
  }]);
...
exports.FACTORY_ABI = factory;
exports.FACTORY_ADDRESS = FACTORY_ADDRESS;
exports.KPI_TOKEN_ABI = kpiToken;
exports.KpiToken = KpiToken;
exports.REALITY_ABI = reality;
exports.REALITY_ADDRESS = REALITY_ADDRESS;
exports.Token = Token;
exports.TokenAmount = TokenAmount;
exports.ZERO_ADDRESS = ZERO_ADDRESS;
//# sourceMappingURL=carrot-sdk.cjs.development.js.map
